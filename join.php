...
if (isset($_REQUEST['userjoin'])) {
  ...
  if (count($errors) == 0) {
    ...
    if ($sql) {
    $msg="<div class='alert alert-success'><b>Request Sent successfully</b></div>";
    }else{
      $msg="<div class='alert alert-warning'><b>Some error occured</b></div>";
    }
  }
}
?>
...
<body>
    ...
    <section class="section">
        <form class="row g-3 py-3 px-3" method="POST">
            <?php include('errors.php'); 
    echo @$msg;
    ?>
            <div class="col-md-6">
                <label for="inputEmail4" class="form-label">First Name</label>
                <input type="text" name="f_name" class="form-control" id="inputEmail4">
            </div>
            <div class="col-md-6">
                <label for="inputPassword4" class="form-label">Last Name</label>
                <input type="text" name="l_name" class="form-control" id="inputPassword4">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-success" name="userjoin">Join now</button>
            </div>
        </form>
