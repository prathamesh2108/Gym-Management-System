...
<body>
    ...
    <section class="section">
        <div class="py-5">
            <h3 class="text-center"> Weekly Routine</h3>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card">
                        <img class="card-img-top" src="images/diet.jpg" alt="Biryani image">
                        <div class="card-body">
                            <h3 class="card-text">Weekly Diet Routine
                            </h3>
                            <a href="week_diet.php" class="btn btn-primary">Read More...</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card">
                        <img class="card-img-top" src="images/img1.jpg" alt="Biryani image">
                        <div class="card-body">
                            <h3 class="card-text">Weekly Workout Routine
                            </h3>
                            <a href="week_wokout.php" class="btn btn-primary">Read More...</a>
                        </div>
                    </div>
                </div>
            </div>
